...
export const metadata: Metadata = {
  ...
  description:
    "Discover Sultan Alzoghaibi's portfolio showcasing web development projects, coding expertise, and design skills. Explore and connect with a passionate developer today.",
};
