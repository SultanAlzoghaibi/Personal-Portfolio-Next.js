...
const leftLists = [
  ...
  { name: "Docker", icon: "/tech-logos/docker.webp" },
];
...
export const BentoGridItem = ({
  ...
  return (
        ...
        {id === 5 && (
          ...
          w-full text-center`
              ...
              <div className="mt-2">
                <LinkButton
                  text="Github"
                  icon="tech-logos/discord.webp"
                  link="https://discord.com/users/h82luzn"
                />
              </div>
            </div>
          </div>
              ...
              <div>
                <div
                  className={`font-sans text-lg lg:text-2xl font-bold z-10 ${
                    id === 3
                      ? "sm:absolute xs:absolute xs:w-40 lg:absolute lg:w-60 lg:mb-5 lg:top-3 lg lg:text-2xl"
                      : ""
                  } ${
                ...
                <Magicbutton
                  link="/myprojects/2"
                  className="absolute bottom-0 mb-4 mr-9 "
                  text="learn more"
                />
              </div>
            </div>
    ...
    ${
      id === 3
        ? "sm:absolute lg:absolute lg:w-60 lg:mb-5 lg:top-3 lg:text-2xl"
        : ""
    }
    ${id === 1 ? "text-primary whitespace-nowrap" : "text-white"}
  `}
            ...
            {id === 3 && (
              <div>
                ...
                <Magicbutton
                  link="/myprojects/2"
                  className="mb-16 pb-5 mr-9 mt-[-0px]"
                  text="learn more"
                />
              </div>
            )}
