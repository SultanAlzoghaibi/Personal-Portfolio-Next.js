...
export function GridBackgroundDemo() {
  return (
    <div className=" h-screen w-full h-full dark:bg-[#0f0e0e] bg-white  dark:bg-grid-white/[0.1] bg-grid-black/[0.9] absolute top-0 left-0 flex items-center justify-center ">
