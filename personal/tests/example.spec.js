...
(0, test_1.test)('should render home page in desktop version', function () { return __awaiter(void 0, void 0, void 0, function () {
    var browser, context, desktopPage, videoElement;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, desktopPage.goto('http://localhost:3000')];
            case 4:
                // Go to the home page (make sure your Next.js app is running on localhost:3000)
                _a.sent();
                return [4 /*yield*/, desktopPage.$('video')];
            case 5:
                videoElement = _a.sent();
                if (videoElement) {
                ...
                return [4 /*yield*/, desktopPage.waitForTimeout(300000)];
            case 6:
                // Keep the browser open to inspect the desktop version of the page
                _a.sent(); // Keep open for 30 seconds for inspection
